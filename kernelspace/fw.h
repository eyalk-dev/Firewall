...
// network repr values
// 10.1.1.3
#define IN_NET_IP_ADDR		0x0301010a
// 10.1.2.3
#define OUT_NET_IP_ADDR		0x0302010a

#define ACTION_ADD_PROXY_AS_CLIENT 1

#define PORT_SMTP			htons(25)
#define PORT_HTTP			htons(80)
#define PORT_ORIENTDB		htons(2480)

#define PORT_PROXY_SMTP		htons(2500)
#define PORT_PROXY_HTTP		htons(8001)
#define PORT_PROXY_ORIENTDB	htons(24801)

#define ACTION_NOT_DECIDED 3

#define LOCALHOST 0x0100007F
// equal to 127.0.0.1 in network repr
#define LOCALHOST_GATE 0x000000FF
// equal to 255.0.0.0 or network repr
